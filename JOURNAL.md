Today thank god went with no fatealities (RIP Arduino), Jay wanted a proof video that its toast, i sent him one. I made the cooling setup with the peltier module, which judging by the almost 2nd degree burn on my hand it gets really hot really fast. and I've added the rocker switch with no soldring cuz i still didnt get a new tip but using the good old egyptian electritians which is tying the wire with the pin in a really weird but super strong way then using tape and heat shrinks. And also I've been working to minimize the GPIO pins needed for the project just in case they didn't fund me, like for examble today instead of a siginal pin, 3 5Vs, and 3 GNDs for the fans and the relay controlling the peltier, my 2mb ram of a brain realized since it will be set to HIGH from setup and always, why don't I use the relay to control all, which saved like 4 pins or smth. like let's calculate the pins needed together, first input through VIN and output from 5V so thats 2 but we wont count that, 3 for the LEDs and buzzer, 4 from the H bridge, freaking 16 from the HC-SR04s, and 3 from the relay. which is total of 16 pins..... and we can't just jam that into the UNO. (Later) i'm back and we will use in that case multiplexing, we'll get all trig pins into one pin to fire at the same time and that saved us 6 more pins which makes it just enough but we risk siginal interference so after asking gemini it said (Recommended Separation (d2): Space the two sensors apart by at least 1/3 to 1/2 of the total face length. For example, on a 30 cm square chassis, space the sensor centers 10 cm to 15 cm apart. Edge Margin (d1 and d3): Keep each sensor roughly 1/4 of the face length away from the corners (e.g., 7.5 cm from the edge on a 30 cm chassis). Angling them outward by 5° to 10° helps cover the dead zones directly at the outer corners of the rover.Height & Obstacles: Mount them at least 5 cm to 10 cm above the ground surface. If placed too low, the bottom edge of the ultrasonic cone will bounce off the floor and trigger false obstacle detections.) Or we can use the half dead Mega to give the GPIO pins to the UNO but i'll search more into that, Its 8am, i still didn't sleep and i'm hallucinating, goodnight

### Sep 22nd, 2026
I just got off the phone with my legendary of a barber Ahmed, he told me today is a rush and I should go tomorrow but that's irrelevant. today I've got an idea to cut even more pins, which is since the relay will be triggered on setup, let's just skip the Arduino completely and make it that it lights up immediately the moment the power runs to the system. now the last thing on the Arduino itself if input through VIN and GND to get 12v down to 5v (or low-key we can just use the other H driver to do so which I feel is a bad idea but u never know ¯⁠\⁠_⁠(⁠ツ⁠)⁠_⁠/⁠¯). and the 9 pins from the HC-SR04s (while making all the trig into one pin), and the 4 motor control pins. but idk I'll see but that means that it's completely doable with the UNO without multiplexers nor using the half dead mega as one, I told Jay that I can get another UNO if another mega would be too much and then both of them will talk through Rx and Rt, but when I thought about it now I can completely pull it off with just the UNO (or I believe at least). I'll re-do it in fritzing real quick with the new adjustments and I'll see what I can do then I'll start to build the electronics into the physical build. (later) I've wroked myself to exhaustion, I've made the fridge, installed all the doors and the mounting system for the last 2 tiers. I've also laid the battery in its place and the H bridge and the motors, but hot glue doesnt hold the motors really well we have to find another way but i'm having a real headache so dont talk to me before tomorrow. GN, oh btw before i forget the battary was super heavy that I had to install the caster wheel i got, thank god for everything.
